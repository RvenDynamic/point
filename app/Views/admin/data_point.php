...
<div class="page-inner">
    <div class="flex justify-between mb-5 ml-3 md:ml-0 font-extrabold text-xl items-center">
        <a href="<?= base_url("/admin/data-pengendara") ?>" class="hover:underline dark:text-gray-200"><i
                        ...
                        <?php foreach ($point as $key => $value) : ?>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="flex  pr-2 py-4 gap-2 items-center">
                                    <a href="<?= base_url("admin/edit-detail/" . $value['id_point']) ?>"
                                    ...
                                    <a href="<?= base_url("admin/detail-point/" . $value['id_point']) ?>"
                                    ...
                                    <button onclick="deletePoint('/admin/hapus-point', <?= $value['id_point'] ?>)"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('/admin/data-point') ?>" method="post"
